...
# map by core 
printf '%s\n' '# mpirun -np 2  --map-by core --report-bindings ./IMB-MPI1 PingPong -msglog 28' > csv/core_ucx.csv
printf '%s\n' '# mpirun -np 2 -mca pml ob1 --mca btl self,tcp  --map-by core --report-bindings ./IMB-MPI1 PingPong -msglog 28' > csv/core_tcp.csv
printf '%s\n' '# mpirun -np 2 -mca pml ob1 --mca btl self,vader  --map-by core --report-bindings ./IMB-MPI1 PingPong -msglog 28' > csv/core_vader.csv
...
# map by socket
printf '%s\n' '# mpirun -np 2 --map-by socket --report-bindings ./IMB-MPI1 PingPong -msglog 28' > csv/socket_ucx.csv 
printf '%s\n' '# mpirun -np 2 -mca pml ob1 --mca btl self,tcp  --map-by socket --report-bindings ./IMB-MPI1 PingPong -msglog 28' > csv/socket_tcp.csv
printf '%s\n' '# mpirun -np 2 -mca pml ob1 --mca btl self,vader  --map-by socket --report-bindings ./IMB-MPI1 PingPong -msglog 28' > csv/socket_vader.csv
...
# map by node
printf '%s\n' '# mpirun -np 2 --map-by node --report-bindings ./IMB-MPI1 PingPong -msglog 28' > csv/node_ucx.csv
printf '%s\n' '# mpirun -np 2 -mca pml ob1 --mca btl self,tcp  --map-by node --report-bindings ./IMB-MPI1 PingPong -msglog 28' > csv/node_tcp.csv
...
# map by core 
printf '%s\n' '# mpirun -n 2 -genv I_MPI_PIN_PROCESSOR_LIST=0,2 ./IMB-MPI1_intel PingPong -msglog 28' > csv/intel_core_ucx.csv
printf '%s\n' '# mpirun -n 2 -genv I_MPI_PIN_PROCESSOR_LIST=0,2 -env I_MPI_FABRICS ofi -genv I_MPI_OFI_PROVIDER tcp ./IMB-MPI1_intel PingPong -msglog 28' > csv/intel_core_tcp.csv
printf '%s\n' '# mpirun -n 2 -genv I_MPI_PIN_PROCESSOR_LIST=0,2 -env I_MPI_FABRICS shm -genv I_MPI_OFI_PROVIDER shm ./IMB-MPI1_intel PingPong -msglog 28' > csv/intel_core_shm.csv
...
# map by socket
printf '%s\n' '# mpirun -n 2 -genv I_MPI_PIN_PROCESSOR_LIST=0,1 ./IMB-MPI1_intel PingPong -msglog 28' > csv/intel_socket_ucx.csv
printf '%s\n' '# mpirun -n 2 -genv I_MPI_PIN_PROCESSOR_LIST=0,1 -env I_MPI_FABRICS ofi -genv I_MPI_OFI_PROVIDER tcp ./IMB-MPI1_intel PingPong -msglog 28' > csv/intel_socket_tcp.csv
printf '%s\n' '# mpirun -n 2 -genv I_MPI_PIN_PROCESSOR_LIST=0,1 -env I_MPI_FABRICS shm -genv I_MPI_OFI_PROVIDER shm  ./IMB-MPI1_intel PingPong -msglog 28' > csv/intel_socket_shm.csv
...
# map by node
printf '%s\n' '# mpirun -n 2 -ppn 1 ./IMB-MPI1_intel PingPong -msglog 28' > csv/intel_node_ucx.csv
printf '%s\n' '# mpirun -n 2 -ppn 1 -env I_MPI_FABRICS ofi -genv I_MPI_OFI_PROVIDER tcp ./IMB-MPI1_intel PingPong -msglog 28' > csv/intel_node_tcp.csv
